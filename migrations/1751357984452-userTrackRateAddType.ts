...
export class UserTrackRateAddType1751357984452 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_tracker_rates" DROP COLUMN "queue_key"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_tracker_rates_type_enum" AS ENUM('project', 'queue', 'global')`);
